{{-- resources/views/dashboard/cursos/edit.blade.php --}}
<x-dashboard-layout>
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 mt-10">
        <div class="flex items-center justify-between mb-6">
            <h1 class="text-3xl font-bold text-white drop-shadow-lg">Editar Curso</h1>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <x-text-input id="curso_url" name="curso_url" type="text" class="mt-1 block w-full" 
                            value="{{ old('curso_url', $curso->curso_url) }}"/>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea id="descripcion_curso" name="descripcion_curso" rows="4" 
                            ...
                            >{{ old('descripcion_curso', $curso->descripcion_curso) }}</textarea>
