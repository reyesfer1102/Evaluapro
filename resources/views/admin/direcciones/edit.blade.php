{{-- resources/views/admin/direcciones/edit.blade.php --}}
<x-dashboard-layout>
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 mt-10">
        <div class="flex items-center justify-between mb-6">
            <h1 class="text-3xl font-bold text-white drop-shadow-lg">Editar Direccion</h1>
        ...
        <div class="bg-white shadow rounded-xl p-6">
            <form action="{{ route('direcciones.update', $direccion->idDireccion) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <x-text-input id="nombre_direccion" name="nombre_direccion" type="text" class="mt-1 block w-full" 
                            value="{{ old('nombre_direccion', $direccion->nombre_direccion) }}" required />
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea id="descripcion_direccion" name="descripcion_direccion" rows="4" 
                            ...
                            >{{ old('descripcion_direccion', $direccion->descripcion_direccion) }}</textarea>
