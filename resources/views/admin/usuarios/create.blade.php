...
<x-dashboard-layout>
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 mt-10">
        <div class="flex items-center justify-between mb-6">
            <h1 class="text-3xl font-bold text-white drop-shadow-lg">Crear Nuevo Usuario</h1>
        ...
        <div class="bg-white shadow rounded-xl p-6">
            <form action="{{ route('usuarios.store') }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        >
                            <option value="">Seleccionar Rol</option>
                                <option value="capacitador" {{ old('rol_usuario') == 'capacitador' ? 'selected' : '' }}>Capacitador</option>
                                <option value="usuario" {{ old('rol_usuario') == 'usuario' ? 'selected' : '' }}>Usuario</option>
                        </select>
                    ...
                    <!-- Fecha -->
                    <div>
                        <x-input-label for="fecha_ingreso" value="Fecha de Ingreso (dejar en blanco para fecha hoy)" />
