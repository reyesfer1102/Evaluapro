{{-- resources/views/admin/puestos/create.blade.php --}}
<x-dashboard-layout>
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 mt-10">
        <div class="flex items-center justify-between mb-6">
            <h1 class="text-3xl font-bold text-white drop-shadow-lg">Crear Nuevo Puesto</h1>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <x-text-input id="nombre_puesto" name="nombre_puesto" type="text" class="mt-1 block w-full" 
                            value="{{ old('nombre_puesto') }}" required />
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea id="descripcion_puesto" name="descripcion_puesto" rows="4" 
                            ...
                            >{{ old('descripcion_puesto') }}</textarea>
