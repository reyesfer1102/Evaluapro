...
<?php endif; ?>
        ...
        <div class="flex flex-col sm:flex-row justify-between items-center gap-4 mb-6">
            <a href="<?php echo e(route('usuarios.create')); ?>" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-xl hover:bg-blue-700 transition">
                <i data-feather="plus" class="mr-2 w-5 h-5"></i> Crear nuevo usuario
            </a>

            <div class="flex flex-col sm:flex-row gap-4 w-full sm:w-2/3">
                <!-- Search Form -->
                <form method="GET" action="<?php echo e(route('usuarios.index')); ?>" class="relative flex-1">
                    <input 
                        type="text" 
                        name="search" 
                    ...
                    <?php if(request('search')): ?>
                        <a href="<?php echo e(route('usuarios.index')); ?>" class="absolute right-3 top-2.5 text-gray-400 hover:text-gray-600">
                ...
                <!-- Filters Form -->
                <form method="GET" action="<?php echo e(route('usuarios.index')); ?>" class="flex gap-2">
                    ...
                    <select name="estatus_filter" class="border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-blue-500 focus:border-blue-500">
                        <option value="none" <?php echo e($estatusFilter === 'none' ? 'selected' : ''); ?>>Todos</option>
                        <option value="1" <?php echo e($estatusFilter === '1' ? 'selected' : ''); ?>>Activos</option>
                        <option value="0" <?php echo e($estatusFilter === '0' ? 'selected' : ''); ?>>Inactivos</option>
                    </select>
        ...
        <?php if(request('search') || request('estatus_filter')): ?>
            <div class="mb-4 text-sm text-gray-600">
                <span class="font-medium"><?php echo e($usuarios->count()); ?></span> resultado(s) encontrado(s)
                <?php if(request('search')): ?>
                    para "<span class="font-medium"><?php echo e(request('search')); ?></span>"
                <?php endif; ?>
                <?php if(request()->has('estatus_filter')): ?>
                    <?php if(request('estatus_filter') === '1'): ?>
                        - <span class="font-medium">Solo Activos</span>
                    <?php elseif(request('estatus_filter') == '0'): ?>
                        - <span class="font-medium">Solo Inactivos</span>
                    <?php endif; ?>
                <?php endif; ?>
                <a href="<?php echo e(route('usuarios.index')); ?>" class="ml-2 text-blue-600 hover:text-blue-800">Limpiar filtros</a>
            </div>
        <?php endif; ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?>Nombre del usuario <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?>Rol Usuario <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal01458c31083fa607d5bca4115c7452df)): ?>
<?php $attributes = $__attributesOriginal01458c31083fa607d5bca4115c7452df; ?>
<?php unset($__attributesOriginal01458c31083fa607d5bca4115c7452df); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?>Fecha de Ingreso <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal01458c31083fa607d5bca4115c7452df)): ?>
<?php $attributes = $__attributesOriginal01458c31083fa607d5bca4115c7452df; ?>
<?php unset($__attributesOriginal01458c31083fa607d5bca4115c7452df); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?>Estatus <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal01458c31083fa607d5bca4115c7452df)): ?>
<?php $attributes = $__attributesOriginal01458c31083fa607d5bca4115c7452df; ?>
<?php unset($__attributesOriginal01458c31083fa607d5bca4115c7452df); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?><?php echo e($usuario->usuario); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?><?php echo e($usuario->rol_usuario); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginale4bbc7ac7aa8c098a103fce9117edf6c)): ?>
<?php $attributes = $__attributesOriginale4bbc7ac7aa8c098a103fce9117edf6c; ?>
<?php unset($__attributesOriginale4bbc7ac7aa8c098a103fce9117edf6c); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?><?php echo e($usuario->puesto ? $usuario->puesto->nombre_puesto : 'Sin puesto'); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginale4bbc7ac7aa8c098a103fce9117edf6c)): ?>
<?php $attributes = $__attributesOriginale4bbc7ac7aa8c098a103fce9117edf6c; ?>
<?php unset($__attributesOriginale4bbc7ac7aa8c098a103fce9117edf6c); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?><?php echo e($usuario->puesto && $usuario->puesto->departamento ? $usuario->puesto->departamento->nombre_departamento : 'Sin Departamento'); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginale4bbc7ac7aa8c098a103fce9117edf6c)): ?>
<?php $attributes = $__attributesOriginale4bbc7ac7aa8c098a103fce9117edf6c; ?>
<?php unset($__attributesOriginale4bbc7ac7aa8c098a103fce9117edf6c); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?><?php echo e($usuario->fecha_ingreso); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginale4bbc7ac7aa8c098a103fce9117edf6c)): ?>
<?php $attributes = $__attributesOriginale4bbc7ac7aa8c098a103fce9117edf6c; ?>
<?php unset($__attributesOriginale4bbc7ac7aa8c098a103fce9117edf6c); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.action-links','data' => ['editUrl' => route('usuarios.edit', $usuario->idUsuario),'showUrl' => route('usuarios.show', $usuario->idUsuario),'deleteUrl' => route('usuarios.destroy', $usuario->idUsuario)]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['edit-url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('usuarios.edit', $usuario->idUsuario)),'show-url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('usuarios.show', $usuario->idUsuario)),'delete-url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('usuarios.destroy', $usuario->idUsuario))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <tr>
                            <?php if (isset($component)) { $__componentOriginale4bbc7ac7aa8c098a103fce9117edf6c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginale4bbc7ac7aa8c098a103fce9117edf6c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.td','data' => ['colspan' => '7','class' => 'text-center text-gray-500 py-8']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('td'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['colspan' => '7','class' => 'text-center text-gray-500 py-8']); ?>
                                <?php if(request('search') || request('estatus_filter')): ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\evaa2\OneDrive\Escritorio\EvaluaPro\evaluaPro\resources\views/admin/usuarios.blade.php ENDPATH**/ ?>