...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.card-dashboard','data' => ['color' => 'blue','icon' => 'briefcase','title' => 'Temas','description' => 'Crear, editar y revisar Temas','link' => ''.e(route('temas.index')).'','linkLabel' => 'Ver Temas →']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['color' => 'blue','icon' => 'briefcase','title' => 'Temas','description' => 'Crear, editar y revisar Temas','link' => ''.e(route('temas.index')).'','linkLabel' => 'Ver Temas →']); ?>
...
<?php endif; ?>
      ...
      <?php if (isset($component)) { $__componentOriginalbb45f589685055c28f5fc69e4ef2650b = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalbb45f589685055c28f5fc69e4ef2650b = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.card-dashboard','data' => ['color' => 'purple','icon' => 'octagon','title' => 'Cursos','description' => 'Crear, editar y revisar cursos','link' => ''.e(route('cursos.index')).'','linkLabel' => 'Ver cursos →']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('card-dashboard'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['color' => 'purple','icon' => 'octagon','title' => 'Cursos','description' => 'Crear, editar y revisar cursos','link' => ''.e(route('cursos.index')).'','linkLabel' => 'Ver cursos →']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalbb45f589685055c28f5fc69e4ef2650b)): ?>
<?php $attributes = $__attributesOriginalbb45f589685055c28f5fc69e4ef2650b; ?>
...
<?php endif; ?><?php /**PATH C:\Users\evaa2\OneDrive\Escritorio\EvaluaPro\evaluaPro\resources\views/dashboard/dashboard-temas.blade.php ENDPATH**/ ?>