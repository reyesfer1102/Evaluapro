...
<?php endif; ?>
        ...
        <div class="flex flex-col sm:flex-row justify-between items-center gap-4 mb-6">
            <a href="<?php echo e(route('puestos.create')); ?>" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-xl hover:bg-blue-700 transition">
                <i data-feather="plus" class="mr-2 w-5 h-5"></i> Crear nuevo puesto
            </a>
            <!-- Search Form --> 
            <div class="flex flex-col sm:flex-row gap-4 w-full sm:w-1/3">

                <form method="GET" action="<?php echo e(route('puestos.index')); ?>" class="relative flex-1">
                    <input 
                        type="text" 
                        name="search" 
                    ...
                    <?php if(request('search')): ?>
                        <a href="<?php echo e(route('puestos.index')); ?>" class="absolute right-3 top-2.5 text-gray-400 hover:text-gray-600">
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?>Nombre del puesto <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?><?php echo e($puesto->nombre_puesto); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?><?php echo e($puesto->descripcion_puesto ? Str::limit($puesto->descripcion_puesto, 75) : 'Sin Descripcion'); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginale4bbc7ac7aa8c098a103fce9117edf6c)): ?>
<?php $attributes = $__attributesOriginale4bbc7ac7aa8c098a103fce9117edf6c; ?>
<?php unset($__attributesOriginale4bbc7ac7aa8c098a103fce9117edf6c); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?><?php echo e($puesto->departamento ? $puesto->departamento->nombre_departamento : 'Sin departamento'); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginale4bbc7ac7aa8c098a103fce9117edf6c)): ?>
<?php $attributes = $__attributesOriginale4bbc7ac7aa8c098a103fce9117edf6c; ?>
<?php unset($__attributesOriginale4bbc7ac7aa8c098a103fce9117edf6c); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.action-links','data' => ['editUrl' => route('puestos.edit', $puesto->idPuesto),'showUrl' => route('puestos.show', $puesto->idPuesto),'deleteUrl' => route('puestos.destroy', $puesto->idPuesto)]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['edit-url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('puestos.edit', $puesto->idPuesto)),'show-url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('puestos.show', $puesto->idPuesto)),'delete-url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('puestos.destroy', $puesto->idPuesto))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\evaa2\OneDrive\Escritorio\EvaluaPro\evaluaPro\resources\views/admin/puestos.blade.php ENDPATH**/ ?>