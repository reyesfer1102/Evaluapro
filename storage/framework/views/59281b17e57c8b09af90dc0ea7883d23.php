...
<?php endif; ?>
        ...
        <div class="flex flex-col sm:flex-row justify-between items-center gap-4 mb-6">
            <a href="<?php echo e(route('departamentos.create')); ?>" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-xl hover:bg-blue-700 transition">
            ...
            <div class="flex flex-col sm:flex-row gap-4 w-full sm:w-1/3">
                ...
                <form method="GET" action="<?php echo e(route('departamentos.index')); ?>" class="relative flex-1">
                    <input 
                        type="text" 
                        name="search" 
                    ...
                    <?php if(request('search')): ?>
                        <a href="<?php echo e(route('departamentos.index')); ?>" class="absolute right-3 top-2.5 text-gray-400 hover:text-gray-600">
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?>Nombre del departamento <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?>Direccion <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal01458c31083fa607d5bca4115c7452df)): ?>
<?php $attributes = $__attributesOriginal01458c31083fa607d5bca4115c7452df; ?>
<?php unset($__attributesOriginal01458c31083fa607d5bca4115c7452df); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?><?php echo e($departamento->nombre_departamento); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?><?php echo e($departamento->descripcion_departamento ? Str::limit($departamento->descripcion_departamento, 75) : 'Sin Descripcion'); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginale4bbc7ac7aa8c098a103fce9117edf6c)): ?>
<?php $attributes = $__attributesOriginale4bbc7ac7aa8c098a103fce9117edf6c; ?>
<?php unset($__attributesOriginale4bbc7ac7aa8c098a103fce9117edf6c); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?><?php echo e($departamento->direccion ? $departamento->direccion->nombre_direccion : 'Sin direccion'); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginale4bbc7ac7aa8c098a103fce9117edf6c)): ?>
<?php $attributes = $__attributesOriginale4bbc7ac7aa8c098a103fce9117edf6c; ?>
<?php unset($__attributesOriginale4bbc7ac7aa8c098a103fce9117edf6c); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.action-links','data' => ['editUrl' => route('departamentos.edit', $departamento->idDepartamento),'showUrl' => route('departamentos.show', $departamento->idDepartamento),'deleteUrl' => route('departamentos.destroy', $departamento->idDepartamento)]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['edit-url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('departamentos.edit', $departamento->idDepartamento)),'show-url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('departamentos.show', $departamento->idDepartamento)),'delete-url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('departamentos.destroy', $departamento->idDepartamento))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\evaa2\OneDrive\Escritorio\EvaluaPro\evaluaPro\resources\views/admin/departamentos.blade.php ENDPATH**/ ?>