    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 mt-10">
        <div class="flex items-center justify-between mb-6">
            ...
            <div class="flex items-center gap-3">
                <a href="<?php echo e(route('puestos.edit', $puesto->idPuesto)); ?>" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-xl hover:bg-blue-700 transition">
                    <i data-feather="edit" class="mr-2 w-5 h-5"></i> Editar
                </a>
                <a href="<?php echo e(route('puestos.index')); ?>" class="inline-flex items-center px-4 py-2 bg-gray-600 text-white rounded-xl hover:bg-gray-700 transition">
        ...
        <div class="bg-white shadow rounded-xl p-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    <h2 class="text-2xl font-bold text-gray-900 mb-4"><?php echo e($puesto->nombre_puesto); ?></h2>
                </div>

                <!-- Departamento -->
                <div>
                    <h3 class="text-lg font-semibold text-gray-700 mb-2">Departamento</h3>
                    <p class="text-gray-600"><?php echo e($puesto->departamento->nombre_departamento); ?></p>
                </div>

                <!-- Descripción -->
                <div class="md:col-span-2">
                    <h3 class="text-lg font-semibold text-gray-700 mb-2">Descripción</h3>
                    <p class="text-gray-600 whitespace-pre-wrap"><?php echo e($puesto->descripcion_puesto); ?></p>
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div class="bg-gray-50 p-4 rounded-lg">
                            ...
                            <p class="text-gray-600"><?php echo e($puesto->idPuesto); ?></p>
                        </div>
                        <div class="bg-gray-50 p-4 rounded-lg">
                            <h4 class="font-medium text-gray-700">Departamento ID</h4>
                            <p class="text-gray-600"><?php echo e($puesto->departamento_id ?? 'No asignado'); ?></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="flex items-center justify-end mt-8 gap-4 pt-6 border-t border-gray-200">
                <form action="<?php echo e(route('puestos.destroy', $puesto->idPuesto)); ?>" method="POST" class="inline" 
...
<?php endif; ?> <?php /**PATH C:\Users\evaa2\OneDrive\Escritorio\EvaluaPro\evaluaPro\resources\views/admin/puestos/show.blade.php ENDPATH**/ ?>